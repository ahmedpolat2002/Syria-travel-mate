      ...
      <ul className={styles.menuList}>
        ...
        {showGovs &&
          ...
          governorates.map((gov) => (
            ...
            >
              <ul>
                <li className={styles.label}>{gov.name}</li>
              </ul>
            </li>
          ))}
        ...
        {selectedLocation &&
          !collapsed &&
          // تحقق إذا كان selectedLocation هو محافظة
          !governorates.some(
            (gov) =>
            ...
            <div className={styles.detailsBox}>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  // حدد نوع الصفحة بناءً على type
                  const isEvent = selectedLocation.type === "فعالية";
                  const basePath = isEvent ? "/events" : "/places";

                  // التوجيه إلى الصفحة المناسبة (ابحث باستخدام الاسم أو لاحقًا بالـ ID)
